...
<head>
  ...
  <title>MI AL-MUHAJIRIN BATU MERAH KOTA BATAM | Data Pengguna</title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 </strong>   </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">haidri</h4>
