...
<head>
    ...
    <style>
        @media (max-width: 768px) {
            ...
            /* Adjust other header elements as needed */
            .header-top_list {
                font-size: 12px;
            }
            /* Meratakan keseluruhan halaman ke tengah */
body {
    text-align: center; /* Meratakan teks ke tengah */
    text-align: center; /* Center align text */
    margin: 1cm auto; /* 1 cm margin on all sides */
}
...
.navbar-nav {
    margin: 0 auto; /* Meratakan navigasi secara horizontal */
    display: inline-block; /* Mengatur navigasi agar berjajar */
}

/* Meratakan judul artikel */
.blog-tiltle_block h4 {
    text-align: center;
}

/* Meratakan deskripsi artikel */
.blog-tiltle_block h6 {
    text-align: center;
}

/* Meratakan komentar */
.blogpost-tabs .tab-content .tab-pane {
    text-align: left; /* Jangan lupa ubah ke left jika konten harus terletak di kiri */
    margin: 0 auto;
}
        ...
        @media (max-width: 576px) {
            ...
            /* Adjust other header elements for smaller devices */
            .header-top_address {
                display: none;
            }
            .blog-img_block img {
...
.container {
    margin: 0 auto; /* Meratakan kontainer ke tengah */
    max-width: 1200px; /* Sesuaikan lebar maksimum sesuai kebutuhan */
}
              ...
              <div class="col-xs-6 col-sm-8 col-md-9">
                  <div class="header-top_address">
                      <div class="header-top_list">
                          <span class="icon-phone"></span>0778411678
                      </div>
                      <div class="header-top_list">
                          <span class="icon-envelope-open"></span>mial-muhajirin.com
                      </div>
                      <div class="header-top_list">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                                ...
                                <p>Email : mial-muhajirin@gmail.com
                                    <br> Phone : 0778411678</p>
