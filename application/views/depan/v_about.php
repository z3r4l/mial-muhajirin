            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span> MI AL-MUHAJIRIN BATU MERAH KEC BATU AMPAR KOTA BATAM KEPULAUAN RIAU
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <p>Hal ini seiring dengan penguasaan teknologi untuk dimanfaatkan sebaik mungkin,
                  ...
                  kami mengejewantahkan nilai-nilai pendidikan yang tertuang dalam visi misi mi al muhajirin,
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">mi al-muhajirin benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan mi al-muhajirin dan menjadi siswa terbaik tahun 2018.</p>
                        ...
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">mi al-muhajirin benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan mi al-muhajirin dan menjadi siswa terbaik tahun 2017. </p>
                            <div class="testi-img_block">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="address">
                                ...
                                <p>Email : MI AL-Muhajirin@gmail.com
